...
const zulfazli = {
  name        : "Zulfazli",
  study       : "Information & Computer Technology",
  role        : "Full-Stack Developer",
  focus       : ["Web Apps", "Mobile Apps", "Discord Bots"],
  currentlyOn : "Building something awesome 🚧",
  motto       : "Code it. Ship it. Improve it.",
};
```

> 🚀 A passionate **Full-Stack Developer** focused on building functional and modern **applications**, **websites**, and **Discord bots**. Experienced across a wide range of technologies — from polished frontends to robust backends, and bot-driven automation.
...
### 💬 Languages
<p>
  <img src="https://skillicons.dev/icons?i=js,ts,python,cs,cpp&theme=dark" />
</p>
...
### ⚙️ Backend
<p>
  <img src="https://skillicons.dev/icons?i=nodejs,express,fastapi,django,dotnet,graphql&theme=dark" />
</p>
